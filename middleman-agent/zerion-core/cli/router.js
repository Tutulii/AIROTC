...
function printUsage() {
  const usage = {
    ...
    airotc: {
      "airotc policy-check --wallet <address> --role seller --chain solana": "Create a deterministic AIR OTC scoped policy proof",
      "airotc verify-seller --wallet <address> --asset SOL --min-amount <n>": "Verify seller asset readiness through Zerion",
      "airotc verify-buyer --wallet <address> --min-value-usd <n>": "Verify buyer wallet readiness through Zerion",
      "airotc execute-demo-tx --execute <from> <to> <amount>": "Execute a real Zerion transaction with the active agent token",
      "airotc proof-bundle --ticket <id>": "Create an AIR OTC Zerion proof bundle hash",
    },
    watchlist: {
